      ...
      <div className="max-w-7xl mx-auto px-6 w-full">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-card-md font-heading font-semibold text-light-text-primary mb-6">
                Let's Talk
              </h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all resize-none"
