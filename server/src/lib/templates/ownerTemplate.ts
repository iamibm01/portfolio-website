              ...
              <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,0.08);">
                ...
                <tr>
                  <td style="padding:36px 40px;">
                    <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border-radius:8px;padding:24px;margin-bottom:28px;">
                      <tr>
                        <td>
                          ...
                          <p style="margin:0 0 6px;font-size:15px;color:#0f172a;"><strong>Name:</strong> ${name}</p>
                          <p style="margin:0;font-size:15px;color:#0f172a;"><strong>Email:</strong> <a href="mailto:${email}" style="color:#6366f1;text-decoration:none;">${email}</a></p>
                        </td>
                      </tr>
                    </table>
                    ...
                    <pre style="margin:0;padding:20px;background:#f8fafc;border-left:3px solid #6366f1;border-radius:0 8px 8px 0;font-size:13px;line-height:1.7;color:#334155;white-space:pre-wrap;font-family:inherit;">${conversationSummary}</pre>
                  </td>
                </tr>
                <!-- Footer -->
                <tr>
